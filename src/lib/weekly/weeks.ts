...
export const weeksData: Record<number, WeekData> = {
  1: {
    ...
    consignas: [
      ...
      { text: "Estudiar el resumen Semana 1.", url: "/lecturas/lectura_semana1.pdf", icon: "lucide:file-text" }
    ],
    evaluaciones: [
  ...
  2: {
    ...
    consignas: [
      { text: "Revisar las secciones correspondientes del Capítulo 1 del libro principal de consulta.", url: "https://tecdigital.tec.ac.cr/dotlrn/catedras.tec/catedradefsicagenerali/file-storage/view/libro%2FCapitulo_01.pdf", icon: "lucide:book-open" },
      { text: "Estudiar el resumen Semana 2.", url: "/lecturas/lectura_semana2.pdf", icon: "lucide:file-text" }
    ],
    evaluaciones: [
      { text: "Práctica 2", url: "/practicas/practica_semana2.pdf", icon: "lucide:calculator" }
    ],
    recursos: [
      { text: "Solución Práctica Semana 1", url: "/soluciones/solucion_practica_semana1.pdf", icon: "lucide:calculator" },
      { text: "PhET: Vectores", url: "https://phet.colorado.edu/sims/html/vector-addition/latest/vector-addition_all.html?locale=es", icon: "lucide:link" }
    ]
  },
  3: {
    ...
    consignas: [
      ...
      { text: "Estudiar el resumen de Semana 3.", url: "/lecturas/lectura_semana3.pdf", icon: "lucide:file-text" }
    ],
    evaluaciones: [
      { text: "Práctica 3", url: "/practicas/practica_semana3.pdf", icon: "lucide:calculator" }
    ],
    recursos: [
      { text: "Solución Práctica Semana 2", url: "/soluciones/solucion_practica_semana2.pdf", icon: "lucide:calculator" }
    ]
  },
  4: {
    ...
    consignas: [
      { text: "Revisar las secciones correspondientes del Capítulo 2 del libro principal de consulta.", url: "https://tecdigital.tec.ac.cr/dotlrn/catedras.tec/catedradefsicagenerali/file-storage/view/libro%2FCapitulo_02.pdf", icon: "lucide:book-open" },
      { text: "Estudiar el resumen de Semana 4.", url: "/lecturas/lectura_semana4.pdf", icon: "lucide:file-text" }
    ],
    evaluaciones: [
      { text: "Práctica 4", url: "/practicas/practica_semana4.pdf", icon: "lucide:calculator" }
    ],
    recursos: [
      { text: "Solución Práctica Semana 3", url: "/soluciones/solucion_practica_semana3.pdf", icon: "lucide:calculator" }
    ]
  },
  5: {
    ...
    consignas: [
      ...
      { text: "Estudiar el resumen de Semana 5.", url: "/lecturas/lectura_semana5.pdf", icon: "lucide:file-text" }
    ],
    evaluaciones: [
      { text: "Práctica 5", url: "/practicas/practica_semana5.pdf", icon: "lucide:calculator" }
    ],
    recursos: [
      { text: "Solución Práctica Semana 4", url: "/soluciones/solucion_practica_semana4.pdf", icon: "lucide:calculator" },
      { text: "Phet: Proyectiles", url: "https://phet.colorado.edu/sims/html/projectile-motion/latest/projectile-motion_all.html?locale=es", icon: "lucide:link" }
    ]
  },
  6: {
    ...
    consignas: [
      ...
      { text: "Estudiar el resumen Semana 6.", url: "/lecturas/lectura_semana6.pdf", icon: "lucide:file-text" }
    ],
    evaluaciones: [
      { text: "Práctica 6", url: "/practicas/practica_semana6.pdf", icon: "lucide:calculator" }
    ],
    recursos: [
      { text: "Solución Práctica Semana 5", url: "/soluciones/solucion_practica_semana5.pdf", icon: "lucide:calculator" },
      { text: "Phet: Leyes de Newton", url: "https://phet.colorado.edu/sims/html/forces-and-motion-basics/latest/forces-and-motion-basics_all.html?locale=es", icon: "lucide:link" }
    ]
  },
  7: {
    ...
    consignas: [
      ...
      { text: "Estudiar el resumen Semana 7.", url: "/lecturas/lectura_semana7.pdf", icon: "lucide:file-text" }
    ],
    evaluaciones: [
      { text: "Práctica 7", url: "/practicas/practica_semana7.pdf", icon: "lucide:calculator" }
    ],
    recursos: [
      { text: "Solución Práctica Semana 6", url: "/soluciones/solucion_practica_semana6.pdf", icon: "lucide:calculator" },
      { text: "Phet: Leyes de Newton", url: "https://phet.colorado.edu/sims/html/forces-and-motion-basics/latest/forces-and-motion-basics_all.html?locale=es", icon: "lucide:link" }
    ]
  },
  8: {
    ...
    consignas: [
      ...
      { text: "Estudiar el resumen Semana 8.", url: "/lecturas/lectura_semana8.pdf", icon: "lucide:file-text" }
    ],
    evaluaciones: [
      { text: "Práctica 8", url: "/practicas/practica_semana8.pdf", icon: "lucide:calculator" }
    ],
    recursos: [
      { text: "Solución Práctica Semana 7", url: "/soluciones/solucion_practica_semana7.pdf", icon: "lucide:calculator" }
    ]
  },
  9: {
    ...
    consignas: [
      ...
      { text: "Estudiar el resumen Semana 9.", url: "/lecturas/lectura_semana9.pdf", icon: "lucide:file-text" }
    ],
    evaluaciones: [
      { text: "Práctica 9", url: "/practicas/practica_semana9.pdf", icon: "lucide:calculator" }
    ],
    recursos: [
      { text: "Solución Práctica Semana 8", url: "/soluciones/solucion_practica_semana8.pdf", icon: "lucide:calculator" }
    ]
  },
  10: {
    ...
    consignas: [
      { text: "Revisar las secciones correspondientes del Capítulo 6 y Capítulo 7 del libro principal de consulta.", url: "https://tecdigital.tec.ac.cr/dotlrn/catedras.tec/catedradefsicagenerali/file-storage/view/libro%2FCapitulo_06.pdf", icon: "lucide:book-open" },
      { text: "Estudiar el resumen Semana 10.", url: "/lecturas/lectura_semana10.pdf", icon: "lucide:file-text" }
    ],
    evaluaciones: [],
    recursos: [
      { text: "Solución Práctica Semana 9", url: "/soluciones/solucion_practica_semana9.pdf", icon: "lucide:calculator" }
    ]
  },
  11: {
    ...
    consignas: [
      ...
      { text: "Estudiar el resumen de sesión 11.", url: "/lecturas/lectura_semana11.pdf", icon: "lucide:file-text" }
    ],
    evaluaciones: [
      { text: "Práctica 11", url: "/practicas/practica_semana11.pdf", icon: "lucide:calculator" }
    ],
    recursos: [
      { text: "Phet: Laboratorio de colisiones", url: "https://phet.colorado.edu/sims/html/collision-lab/latest/collision-lab_all.html?locale=es", icon: "lucide:link" }
    ]
  },
  12: {
    ...
    consignas: [
      ...
      { text: "Estudiar el resumen SEMANA 12.", url: "/lecturas/lectura_semana12.pdf", icon: "lucide:file-text" }
    ],
    evaluaciones: [
      { text: "Práctica 12", url: "/practicas/practica_semana12.pdf", icon: "lucide:calculator" }
    ],
    recursos: [
      { text: "Solución Práctica Semana 11", url: "/soluciones/solucion_practica_semana11.pdf", icon: "lucide:calculator" }
    ]
  },
  13: {
    ...
    consignas: [
      { text: "Revisar las secciones correspondientes del Capítulo 9 del libro principal de consulta.", url: "https://tecdigital.tec.ac.cr/dotlrn/catedras.tec/catedradefsicagenerali/file-storage/view/libro%2FCapitulo_09.pdf", icon: "lucide:book-open" },
      { text: "Estudiar el resumen SEMANA 13.", url: "/lecturas/lectura_semana13.pdf", icon: "lucide:file-text" }
    ],
    evaluaciones: [
      { text: "Práctica 13", url: "/practicas/practica_semana13.pdf", icon: "lucide:calculator" }
    ],
    recursos: [
      { text: "Solución Práctica Semana 12", url: "/soluciones/solucion_practica_semana12.pdf", icon: "lucide:calculator" }
    ]
  },
  14: {
    ...
    consignas: [
      ...
      { text: "Estudiar el resumen SEMANA 14.", url: "/lecturas/lectura_semana14.pdf", icon: "lucide:file-text" }
    ],
    evaluaciones: [
      { text: "Práctica 14", url: "/practicas/practica_semana14.pdf", icon: "lucide:calculator" }
    ],
    recursos: [
      { text: "Solución Práctica Semana 13", url: "/soluciones/solucion_practica_semana13.pdf", icon: "lucide:calculator" }
    ]
  },
  15: {
    ...
    consignas: [
      ...
      { text: "Estudiar el resumen SEMANA 15.", url: "/lecturas/lectura_semana15.pdf", icon: "lucide:file-text" }
    ],
    evaluaciones: [
      { text: "Práctica 15", url: "/practicas/practica_semana15.pdf", icon: "lucide:calculator" }
    ],
    recursos: [
      { text: "Solución Práctica Semana 14", url: "/soluciones/solucion_practica_semana14.pdf", icon: "lucide:calculator" }
    ]
  },
  16: {
    ...
    consignas: [
      ...
      { text: "Estudiar el resumen de Semana 16.", url: "/lecturas/lectura_semana16.pdf", icon: "lucide:file-text" }
    ],
    evaluaciones: [],
    recursos: []
  }
