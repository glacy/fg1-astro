...
export const weeksData: Record<number, WeekData> = {
  1: {
    ...
    consignas: [
      ...
      { text: "Estudiar el resumen Semana 1.", url: "./../lecturas/semana-1", icon: "lucide:file-text" }
    ],
    evaluaciones: [
  ...
  2: {
    ...
    consignas: [
      { text: "Revisar las secciones correspondientes del Capítulo 1 del libro principal de consulta.", url: "https://tecdigital.tec.ac.cr/dotlrn/catedras.tec/catedradefsicagenerali/file-storage/view/libro%2FCapitulo_01.pdf", icon: "lucide:book-open" },
      { text: "Estudiar el resumen Semana 2.", url: "./../lecturas/semana-2", icon: "lucide:file-text" }
    ],
    evaluaciones: [
  ...
  3: {
    ...
    consignas: [
      ...
      { text: "Estudiar el resumen de Semana 3.", url: "./../lecturas/semana-3", icon: "lucide:file-text" }
    ],
    evaluaciones: [
  ...
  4: {
    ...
    consignas: [
      { text: "Revisar las secciones correspondientes del Capítulo 2 del libro principal de consulta.", url: "https://tecdigital.tec.ac.cr/dotlrn/catedras.tec/catedradefsicagenerali/file-storage/view/libro%2FCapitulo_02.pdf", icon: "lucide:book-open" },
      { text: "Estudiar el resumen de Semana 4.", url: "./../lecturas/semana-4", icon: "lucide:file-text" }
    ],
    evaluaciones: [
  ...
  5: {
    ...
    consignas: [
      ...
      { text: "Estudiar el resumen de Semana 5.", url: "./../lecturas/semana-5", icon: "lucide:file-text" }
    ],
    evaluaciones: [
  ...
  6: {
    ...
    consignas: [
      ...
      { text: "Estudiar el resumen Semana 6.", url: "./../lecturas/semana-6", icon: "lucide:file-text" }
    ],
    evaluaciones: [
  ...
  7: {
    ...
    consignas: [
      ...
      { text: "Estudiar el resumen Semana 7.", url: "./../lecturas/semana-7", icon: "lucide:file-text" }
    ],
    evaluaciones: [
  ...
  8: {
    ...
    consignas: [
      ...
      { text: "Estudiar el resumen Semana 8.", url: "./../lecturas/semana-8", icon: "lucide:file-text" }
    ],
    evaluaciones: [
  ...
  9: {
    ...
    consignas: [
      ...
      { text: "Estudiar el resumen Semana 9.", url: "./../lecturas/semana-9", icon: "lucide:file-text" }
    ],
    evaluaciones: [
  ...
  10: {
    ...
    consignas: [
      { text: "Revisar las secciones correspondientes del Capítulo 6 y Capítulo 7 del libro principal de consulta.", url: "https://tecdigital.tec.ac.cr/dotlrn/catedras.tec/catedradefsicagenerali/file-storage/view/libro%2FCapitulo_06.pdf", icon: "lucide:book-open" },
      { text: "Estudiar el resumen Semana 10.", url: "./../lecturas/semana-10", icon: "lucide:file-text" }
    ],
    evaluaciones: [],
    recursos: [
  ...
  11: {
    ...
    consignas: [
      ...
      { text: "Estudiar el resumen de sesión 11.", url: "./../lecturas/semana-11", icon: "lucide:file-text" }
    ],
    evaluaciones: [
  ...
  12: {
    ...
    consignas: [
      ...
      { text: "Estudiar el resumen SEMANA 12.", url: "./../lecturas/semana-12", icon: "lucide:file-text" }
    ],
    evaluaciones: [
  ...
  13: {
    ...
    consignas: [
      { text: "Revisar las secciones correspondientes del Capítulo 9 del libro principal de consulta.", url: "https://tecdigital.tec.ac.cr/dotlrn/catedras.tec/catedradefsicagenerali/file-storage/view/libro%2FCapitulo_09.pdf", icon: "lucide:book-open" },
      { text: "Estudiar el resumen SEMANA 13.", url: "./../lecturas/semana-13", icon: "lucide:file-text" }
    ],
    evaluaciones: [
  ...
  14: {
    ...
    consignas: [
      ...
      { text: "Estudiar el resumen SEMANA 14.", url: "./../lecturas/semana-14", icon: "lucide:file-text" }
    ],
    evaluaciones: [
  ...
  15: {
    ...
    consignas: [
      ...
      { text: "Estudiar el resumen SEMANA 15.", url: "./../lecturas/semana-15", icon: "lucide:file-text" }
    ],
    evaluaciones: [
  ...
  16: {
    ...
    consignas: [
      ...
      { text: "Estudiar el resumen de Semana 16.", url: "./../lecturas/semana-16", icon: "lucide:file-text" }
    ],
    evaluaciones: [],
    recursos: []
  }
