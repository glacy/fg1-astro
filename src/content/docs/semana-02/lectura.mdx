...
La suma de dos vectores $$\overrightarrow{A}$$ y $$\overrightarrow{B}$$ se puede representar gráficamente usando la **regla del paralelogramo**. Para sumar $$\overrightarrow{A} + \overrightarrow{B}$$:
...
3. La diagonal del paralelogramo (desde el origen) representa el vector resultante $$\overrightarrow{R}$$
...
1. Dibuja el primer vector $$\overrightarrow{A}$$ desde un punto de origen
2. Dibuja el segundo vector $$\overrightarrow{B}$$ con su origen en la cabeza (punta) de $$\overrightarrow{A}$$
3. El vector resultante $$\overrightarrow{R}$$ va desde el origen de $$\overrightarrow{A}$$ hasta la cabeza de $$\overrightarrow{B}$$
...
La resta de vectores $$\overrightarrow{A} - \overrightarrow{B}$$ es equivalente a la suma de $$\overrightarrow{A}$$ con el opuesto de $$\overrightarrow{B}$$:

$$
\overrightarrow{A} - \overrightarrow{B} = \overrightarrow{A} + (-\overrightarrow{B})
$$

Gráficamente, el opuesto de un vector $$\overrightarrow{B}$$ se obtiene invirtiendo su dirección (manteniendo la misma magnitud pero apuntando en sentido contrario). Luego se aplica la regla del polígono.
...
Para un vector $\overrightarrow{A}$ con magnitud $A$ y ángulo $\theta$ respecto al eje $x$ positivo:
...
Un objeto se mueve bajo la acción de dos fuerzas: $$\overrightarrow{F}_1 = 50 \, \mathrm{N}$$ en dirección $$37^\circ$$ sobre el eje $$x$$, y $$\overrightarrow{F}_2 = 30 \, \mathrm{N}$$ en dirección $$53^\circ$$ sobre el eje $$x$$. Encontrar la fuerza resultante.
...
Por lo tanto, la fuerza resultante es $$$$\overrightarrow{R} = 79,27 \, \mathrm{N}$$$$ en dirección $$$$42,97^\circ$$$$ sobre el eje $$$$x$$$$.
...
- $$\hat{i}$$: vector unitario en dirección del eje $$x$$ positivo
...
Cualquier vector $$\overrightarrow{A}$$ puede expresarse como:
...
Dados los vectores $$\overrightarrow{A} = 3\hat{i} + 4\hat{j} \, \mathrm{m}$$ y $$\overrightarrow{B} = -2\hat{i} + 5\hat{j} \, \mathrm{m}$$, encontrar $$\overrightarrow{A} + \overrightarrow{B}$$ y $$\overrightarrow{A} - \overrightarrow{B}$$.

Suma:
$$
\overrightarrow{A} + \overrightarrow{B} = (3 + (-2))\hat{i} + (4 + 5)\hat{j} = 1\hat{i} + 9\hat{j} \, \mathrm{m}
$$

Resta:
$$
\overrightarrow{A} - \overrightarrow{B} = (3 - (-2))\hat{i} + (4 - 5)\hat{j} = 5\hat{i} - 1\hat{j} \, \mathrm{m}
$$

Para encontrar la magnitud del vector suma:

$$
|\overrightarrow{A} + \overrightarrow{B}| = \sqrt{1^2 + 9^2} = \sqrt{1 + 81} = \sqrt{82} = 9,06 \, \mathrm{m}
$$
