...
*   La temperatura ambiente es de $$25 \, ^\circ\mathrm{C}$$.
*   La densidad del agua es de $$1000 \, \mathrm{kg/m}^3$$.
*   La distancia total recorrida entre San José y Cartago es de $$13 \, \mathrm{km}$$.
*   El índice de refracción del aire es igual a $$1$$ (adimensional).
...
*   El viento sopla con una velocidad de $$20 \, \mathrm{km/h}$$ hacia el Noreste.
*   Mi colegio está a $$1 \, \mathrm{km}$$ y $$30^\circ$$ al sur de mi casa.
*   En la Tierra, los objetos en caída libre experimentan una aceleración de $$9,81 \, \mathrm{m/s}^2$$ dirigida hacia el centro del planeta.
*   El campo magnético terrestre tiene una magnitud de $$5 \times 10^{-5} \, \mathrm{T}$$ y está orientado $$11^\circ$$ respecto al eje de rotación.

Para entender por qué esta distinción es vital, pensemos en el *desplazamiento* de un objeto al moverse de un punto A a un punto B. Esta cantidad es un vector, ya que no basta con saber que la distancia entre ambos es de $$5 \, \mathrm{km}$$ (escalar); necesitamos saber la ubicación de B respecto a A. Si solo usáramos la distancia, el objeto podría estar en cualquier parte de una circunferencia. Observe esta diferencia en la situación descrita en la Figura [1.3].
